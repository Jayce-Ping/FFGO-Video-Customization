    ...
    def get_batch(self, idx):
        ...
        if data_info.get('type', 'image')=='video':
            ...
            with VideoReader_contextmanager(video_dir, num_threads=2) as video_reader:
                ...
                # print('video_dir', video_dir, len(video_reader))
                # print("video length, clip_length, start_idx, batch_index", video_length, clip_length, start_idx, batch_index)
                # '''
                # video_dir /fs/nexus-projects/DroneHuman/jxchen/data/06_VideoRAG/Data/test_videos/raw/airplane.mp4 1253
                # video length, clip_length, start_idx, batch_index 1253 145  
                # '''
                # exit(0)
                ...
                try:
                    ...
                    for i in range(len(pixel_values)):
                        ...
                        if i < 4:
                            resized_frame= ref_image
                            # print('i', i, frame.shape, resized_frame.shape)


                        resized_frame = cv2.resize(resized_frame, (self.width, self.height))



                        # print('frame shape, resized_frame shape', frame.shape, resized_frame.shape)
                        # '''
                        # frame shape, resized_frame shape (640, 362, 3) (640, 362, 3)
                        # '''
                    ...
                    # print('pixel_values after resizing', pixel_values.shape)
                    # '''
                    # pixel_values after resizing (49, 640, 360, 3)
                    # '''
                    # exit(0)
                ...
                # print('pixel_values after transforms', pixel_values.shape)
                # '''
                # pixel_values after transforms (49, 640, 360, 3)
                # '''
                # exit(0)
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            try:
                ...
                # print('pixel_values', pixel_values.shape, data_type, name)
                # '''
                # pixel_values (81, 640, 362, 3) video ad23r2 the camera view suddenly changes to reveal, the women pick up the object
                # '''
        ...
        # print('sample pixel_values', sample["pixel_values"].shape, sample["data_type"], sample["text"])
        # '''
        # sample pixel_values (1, 832, 624, 3)
        # '''
        # exit(0)
