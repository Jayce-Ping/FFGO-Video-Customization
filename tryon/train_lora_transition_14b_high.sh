...
accelerate launch --num_processes=8 --multi_gpu --mixed_precision="bf16" ../VideoX-Fun/scripts/wan2.2/train_lora_transition_14b.py \
  ...
  --learning_rate=1e-04 \
  --seed=42 \
  --output_dir="/scratch/prj0000000275/jcy/tryon/tryon_high" \
