...
python ./VideoX-Fun/examples/wan2.2/single_predict.py \
    ...
    --config_path ./VideoX-Fun/config/wan2.2/wan_civitai_i2v.yaml \
    --output_path ./output/ffgo_eval \
    --image_path ./Data/combined_first_frames/fun.png \
    --caption "ad23r2 the camera view suddenly changes. A full shot of Donald Trump and Kim Jong-un standing side-by-side on the lawn in front of the White House. They slowly turn to face each other, making eye contact. Their expressions soften as they lean in and share a passionate, romantic kiss."